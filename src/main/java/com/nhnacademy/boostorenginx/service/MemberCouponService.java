...
public interface MemberCouponService {
    ...
    Page<MemberCouponResponseDto> getMemberCouponsByCouponId(MemberCouponFindByCouponIdRequestDto requestDto); // 쿠폰의 ID로 회원쿠폰 조회

    Page<MemberCouponGetResponseDto> getMemberCouponsByMemberId(MemberCouponFindByMemberIdRequestDto requestDto); // 회원 ID에 해당되는 회원쿠폰 관계들을 모두 조회
