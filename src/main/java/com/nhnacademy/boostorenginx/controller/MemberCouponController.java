...
public class MemberCouponController {
    ...
    // 회원이 쿠폰 사용
    @PatchMapping("/member-coupons/coupon/use")
    ...
    // 쿠폰 ID 로 회원쿠폰 조회
    @GetMapping("/member-coupons/coupon/{couponId}")
    ...
    // 회원 ID 로 회원쿠폰 조회
    @GetMapping("/member-coupons/member/{memberId}")
    public ResponseEntity<Page<MemberCouponGetResponseDto>> getMemberCouponsByMemberId(@PathVariable("memberId") Long memberId, Pageable pageable) {
    ...
    public ResponseEntity<Page<MemberCouponGetResponseDto>> getUnusedMemberCouponsByMemberId(@PathVariable("memberId") Long memberId, Pageable pageable) {
        MemberCouponFindByMemberIdRequestDto requestDto = new MemberCouponFindByMemberIdRequestDto(memberId, pageable.getPageNumber(), pageable.getPageSize());
