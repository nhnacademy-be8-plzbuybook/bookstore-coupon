package com.nhnacademy.bookstorecoupon.skm.service;


import com.nhnacademy.bookstorecoupon.skm.dto.KeyResponseDto;
...
class SecureKeyManagerServiceTest {
    ...
    @Test
    void fetchSecret_shouldThrowKeyManagerException_whenKeyStoreInitializationFails() {
