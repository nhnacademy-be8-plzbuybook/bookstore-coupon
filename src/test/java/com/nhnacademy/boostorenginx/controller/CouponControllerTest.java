...
//
//        useRequestDto = new MemberCouponUseRequestDto(
//                1L, // couponId
//                1L  // memberId
//        );
//    }
...
//        mockMvc.perform(patch("/api/coupons/update-expired")
//                        .contentType(MediaType.APPLICATION_JSON)
...
//        mockMvc.perform(patch("/api/coupons/use")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(objectMapper.writeValueAsString(useRequestDto)))
//                .andExpect(status().isOk())
