...
//
//        mockMvc.perform(get("/api/coupons/histories")
//                        .param("couponHistoryId", String.valueOf(findRequestDto.couponHistoryId()))
...
//                .thenReturn(filter);
//
//        mockMvc.perform(get("/api/coupons/histories/status")
//                        .param("status", status)
...
//                .thenReturn(filter);
//
//        mockMvc.perform(get("/api/coupons/histories/active")
